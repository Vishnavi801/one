...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>summer Collection 3030</h1>
            <p>Discover the latest trends in fashion, technology and accessories with up to 10% off selected items</p>
